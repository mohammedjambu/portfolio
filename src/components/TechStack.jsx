        ...
        {[...Array(4)].map((_, i) => (
          <React.Fragment key={i}>
            {items.map((item, idx) => (
              <div
                key={idx}
                className="flex items-center gap-4 px-8 py-4 rounded-4xl bg-white border border-black/4 shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-500 group"
              >
                <span
                ...
                <span
                  ...
                  style={{
                    color: item.color === "#000000" ? "#111113" : item.color,
                  }}
                >
                  {item.name}
                </span>
...
export default function TechStack() {
  return (
    <section
      id="tech"
      className="relative py-32 md:py-48 bg-[#F8F9FA] overflow-hidden"
    >
      {/* Background Dot Grid */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="mb-12 flex flex-col md:flex-row items-end justify-between gap-10">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter mt-6 leading-[0.8] text-onyx">
              THE{" "}
          ...
          <p className="max-w-85 text-xs font-mono uppercase tracking-[0.2em] leading-relaxed">
            The tools behind the work. <span className="text-zinc-600">A focused stack for building polished
            interfaces, scalable applications, and reliable digital products.</span>
          </p>
        </div>
        ...
        <div className="mt-8 flex justify-center">
          <div className="flex items-center gap-4 px-8 py-3 rounded-full bg-white border border-black/5 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[12px] font-bold font-mono uppercase tracking-[0.2em] text-zinc-600">
